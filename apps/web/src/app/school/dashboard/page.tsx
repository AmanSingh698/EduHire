...
import {
  GraduationCap, Users, Briefcase, Eye,
  Bell, Plus, CheckCircle, Clock, ChevronRight,
  BarChart2, Settings, LogOut, Building2,
  ArrowUpRight, Zap, X, Award, Phone, MapPin,
  BookOpen, FileText, UserCheck, XCircle, MessageSquare
} from "lucide-react";
        ...
        >
          ...
          >
            ...
            <div style={{ padding: "1.5rem", background: "linear-gradient(135deg, #0f172a, #1e1b4b)", borderRadius: "var(--radius-2xl) var(--radius-2xl) 0 0", position: "relative" }}>
              <button
                onClick={() => setSelectedApp(null)}
                style={{ position: "absolute", top: "1rem", right: "1rem", background: "rgba(255,255,255,0.1)", border: "none", borderRadius: "50%", width: 32, height: 32, display: "flex", alignItems: "center", justifyContent: "center", cursor: "pointer", color: "#fff" }}
              >
                <X size={16} />
              </button>
              <div style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
                <div style={{
                  ...
                  background: t?.photoUrl ? "transparent" : "linear-gradient(135deg, #4f46e5, #7c3aed)",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  fontSize: "1.5rem", fontWeight: 800, color: "#fff", flexShrink: 0, overflow: "hidden",
                ...
                <div>
                  ...
                  <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem", alignItems: "center" }}>
                    ...
                    <span style={{ fontSize: "0.72rem", fontWeight: 700, padding: "0.15rem 0.6rem", borderRadius: "var(--radius-full)", background: s.bg, color: s.color }}>
                      {selectedApp.status}
                    </span>
                  </div>
                </div>
            ...
            <div style={{ padding: "1.5rem", display: "flex", flexDirection: "column", gap: "1.25rem" }}>
              ...
              <div style={{ padding: "0.85rem 1rem", background: "var(--primary-50)", borderRadius: "var(--radius-lg)", border: "1px solid var(--primary-100)" }}>
                ...
                <div style={{ fontSize: "0.75rem", color: "var(--text-muted)", marginTop: "0.15rem" }}>
                  Applied on {new Date(selectedApp.createdAt).toLocaleDateString("en-IN", { day: "numeric", month: "short", year: "numeric" })}
                </div>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem" }}>
                {[
                  ...
                  <div key={item.label} style={{ padding: "0.75rem", background: "var(--gray-50)", borderRadius: "var(--radius-lg)", border: "1px solid var(--border-color)" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.3rem", fontSize: "0.72rem", fontWeight: 700, color: "var(--text-muted)", textTransform: "uppercase", letterSpacing: "0.04em", marginBottom: "0.3rem" }}>
                ...
                {t?.resumeUrl && (
                  <a href={t.resumeUrl} target="_blank" rel="noopener noreferrer"
                    style={{ padding: "0.75rem", background: "var(--success-50)", borderRadius: "var(--radius-lg)", border: "1px solid var(--success-200)", textDecoration: "none", display: "flex", flexDirection: "column", gap: "0.3rem" }}>
                    <div style={{ fontSize: "0.72rem", fontWeight: 700, color: "var(--success-600)", textTransform: "uppercase", letterSpacing: "0.04em", display: "flex", alignItems: "center", gap: "0.3rem" }}>
              ...
              {t?.bio && (
                <div>
                  <div style={{ fontSize: "0.8rem", fontWeight: 700, color: "var(--text-muted)", marginBottom: "0.4rem", display: "flex", alignItems: "center", gap: "0.3rem" }}>
                    <MessageSquare size={13} /> About
                  </div>
              ...
              {t?.subjects && t.subjects.length > 0 && (
                <div>
                  <div style={{ fontSize: "0.8rem", fontWeight: 700, color: "var(--text-muted)", marginBottom: "0.5rem", display: "flex", alignItems: "center", gap: "0.3rem" }}>
              ...
              <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap", paddingTop: "0.5rem", borderTop: "1px solid var(--border-color)" }}>
                {selectedApp.status !== "SHORTLISTED" && (
                  <button
                    ...
                    disabled={!!isUpdating}
                    style={{ flex: 1, padding: "0.65rem", background: "#d1fae5", color: "#065f46", border: "1px solid #a7f3d0", borderRadius: "var(--radius-lg)", fontWeight: 700, fontSize: "0.85rem", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.4rem", transition: "all 0.15s" }}
                  >
                    <UserCheck size={15} /> {isUpdating ? "..." : "Shortlist"}
                  </button>
                )}
                {selectedApp.status !== "INTERVIEW" && (
                  <button
                    ...
                    disabled={!!isUpdating}
                    style={{ flex: 1, padding: "0.65rem", background: "#fef3c7", color: "#92400e", border: "1px solid #fde68a", borderRadius: "var(--radius-lg)", fontWeight: 700, fontSize: "0.85rem", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.4rem", transition: "all 0.15s" }}
                  >
                    <MessageSquare size={15} /> {isUpdating ? "..." : "Interview"}
                  </button>
                )}
                {selectedApp.status !== "REJECTED" && (
                  <button
                    ...
                    disabled={!!isUpdating}
                    style={{ flex: 1, padding: "0.65rem", background: "#fee2e2", color: "#991b1b", border: "1px solid #fca5a5", borderRadius: "var(--radius-lg)", fontWeight: 700, fontSize: "0.85rem", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: "0.4rem", transition: "all 0.15s" }}
                  >
                              ...
                              <td style={{ padding: "1rem" }}>
                                <div style={{ display: "flex", gap: "0.4rem", flexWrap: "wrap" }}>
                                  <button
                                    ...
                                    style={{ padding: "0.3rem 0.65rem", fontSize: "0.75rem", fontWeight: 600, background: "var(--primary-50)", color: "var(--primary-700)", border: "none", borderRadius: "var(--radius-lg)", cursor: "pointer", display: "flex", alignItems: "center", gap: "0.3rem" }}
                                  >
